...
export const styles = StyleSheet.create({
  ...
  groupImageContainer: {
    width: scaleModerate(65),
    height: scaleModerate(65),
  ...
  groupImage: {
    ...
    height: scaleModerate(63),
    borderRadius: scaleModerate(5),
  },

  groupDescriptionRightContainer: {
    width: scaleModerate(295),
